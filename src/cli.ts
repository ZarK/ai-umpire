    ...
    createSchemaCommand({
      ...
      sections: {
        ...
        continuationState: {
          ...
          logFields: ["event", "observedAt", "eventType", "hostId", "sessionId", "selectedSessionId", "decisionId", "decisionKind", "mode", "promptKind", "selectedItem", "reasonCodes", "promptFingerprint", "targetSessionId", "sourceSummaries", "adapterErrors", "suppressions", "elapsedMs", "message"],
          rotation: {
            maxLogBytes: 65536,
        ...
        status: {
          outputShape: ["config", "inputEnvelopes", "adapterRuns", "normalizedStateSummary", "decision", "prompt", "whip", "paths", "continuationState", "reasonLabels", "staleSources", "unknownSources", "errors", "warnings"],
        ...
        whip: {
          ...
          selectedTaskFields: ["id", "title", "prompt", "priority", "promptFingerprint"],
          statusFields: ["enabled", "statePath", "stateOk", "tasks", "counts", "staleOwnership", "errors"],
        ...
        doctor: {
          ...
          stableDiagnosticKinds: [
            ...
            "planning-trusted-command-found",
            "planning-trusted-command-missing",
            "quality-mode-enabled",
            "quality-mode-disabled",
            "quality-trusted-command-found",
            "quality-trusted-command-missing",
            "whip-mode-disabled",
            "whip-state-valid",
            "whip-state-malformed",
            "whip-stale-ownership",
            "whip-orphaned-ownership",
            "whip-ownership-current",
            "whip-ownership-linked",
